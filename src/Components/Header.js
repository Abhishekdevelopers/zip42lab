  ...
  return (
    ...
    <>
      <div>
        ...
        <div className='logo'>
            <img src='/zip42lab-wthite 1.png' alt='logo' className='logoimg'></img>
        </div>
          <div className='main-nav'>
            ...
            <a href='#' className='aheader'> <img src='/image/search.png' alt='search'></img> Search</a>
            </div>
            <div className={
...
We believe in the power of designs.
         ...
         <button className='head-btn'>ENQUIRE NOW</button>
            ...
            <div className='col-md-6' >
              <img className='header-img' src='/image/man-proud-himself 1.png' alt='header'></img>
            </div>
            </div>
            </div>
      </div>
